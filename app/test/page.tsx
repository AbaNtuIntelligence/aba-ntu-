...
import {
  ...
  BarChart3, Users, Award, Infinity, Crown, Compass,
  Layers, Briefcase, Heart, Star, Lock, ArrowRight,
  Eye, Feather, TrendingUp, Lightbulb, Globe
} from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={path.title} className={`bg-white rounded-xl shadow-md overflow-hidden border-l-8 border-${path.color}-500 hover:shadow-xl transition-all`}>
                <div className="p-6">
