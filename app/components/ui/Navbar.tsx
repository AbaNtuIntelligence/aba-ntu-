  ...
  return (
    <nav className="fixed top-0 right-0 left-0 lg:left-64 z-30 bg-transparent backdrop-blur-md border-b border-white/20 shadow-sm">
      <div className="px-4 py-3 flex justify-between items-center">
        {/* Mobile menu button */}
        <button onClick={onMenuClick} className="lg:hidden p-2 rounded-lg hover:bg-white/20">
        ...
        <Link href="/" className="hidden lg:flex items-center gap-2">
          ...
          <span className="font-bold text-xl text-gray-900">AbaNtu</span>
        </Link>
        ...
        <div className="flex items-center gap-3 ml-auto">
          ...
          {profile?.avatar_url ? (
            <img src={profile.avatar_url} alt="Avatar" className="w-10 h-10 rounded-full object-cover border-2 border-purple-300" />
          ) : (
          ...
          <button onClick={onLogout} className="p-2 rounded-lg hover:bg-red-100 text-red-600 transition-colors" title="Logout">
